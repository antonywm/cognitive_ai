...
#   letter.py
#   This analyses an image with a scanned letter (or any typed text) and converts into ASCII text, displayed on
#   the command line
# 
...
# Read the image file
image_path = os.path.join('images', 'ocr', 'customer-letter.jpg')
